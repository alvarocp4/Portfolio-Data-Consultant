...
<\/script>`])), maybeRenderHead(), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "#home", "class": "px-2 py-3 text-[color:var(--color-text-secondary)] no-underline" }, { "default": ($$result2) => renderTemplate`Home` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "#skills", "class": "px-2 py-3 text-[color:var(--color-text-secondary)] no-underline" }, { "default": ($$result2) => renderTemplate`Skills & Tools` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "#experience", "class": "px-2 py-3 text-[color:var(--color-text-secondary)] no-underline" }, { "default": ($$result2) => renderTemplate`Experience` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "#projects", "class": "px-2 py-3 text-[color:var(--color-text-secondary)] no-underline" }, { "default": ($$result2) => renderTemplate`Projects` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "#certifications", "class": "px-2 py-3 text-[color:var(--color-text-secondary)] no-underline" }, { "default": ($$result2) => renderTemplate`Certifications` }), renderComponent($$result, "ThemeToggle", $$ThemeToggle, {}), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/", "class": "px-2 py-3" }, { "default": ($$result2) => renderTemplate`Resume` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/SkillsSection", "class": "px-2 py-3" }, { "default": ($$result2) => renderTemplate`Skills & Tools` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/WorkExperience", "class": "px-2 py-3" }, { "default": ($$result2) => renderTemplate`Experience` }), renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/Projects", "class": "px-2 py-3" }, { "default": ($$result2) => renderTemplate`Projects` }));
